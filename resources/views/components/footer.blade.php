    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div class="lg:col-span-2">
                <a href="/" class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-xl font-bold text-white">FoodExpress</span>
                </a>
                <p class="mb-4 text-gray-400">
                    Your favorite food, delivered fast. Order from the best restaurants in your area.
                </p>
                <div class="flex gap-3">
                    <a href="#" class="bg-gray-800 hover:bg-orange-500 p-2 rounded-full transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="hover:text-orange-500 transition-colors">Menu</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition-colors">Restaurants</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition-colors">Become a Partner</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-2">
                        ...
                        <span class="text-sm">123 Food Street, New York, NY 10001</span>
                    </li>
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <span class="text-sm">info@foodexpress.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-6">
                <img src="https://via.placeholder.com/50x30/1a1a1a/ffffff?text=VISA" alt="Visa"
                    class="h-6 opacity-70">
                <img src="https://via.placeholder.com/50x30/1a1a1a/ffffff?text=MC" alt="Mastercard"
                    class="h-6 opacity-70">
                <img src="https://via.placeholder.com/50x30/1a1a1a/ffffff?text=AMEX" alt="Amex"
                    class="h-6 opacity-70">
                <img src="https://via.placeholder.com/50x30/1a1a1a/ffffff?text=PayPal" alt="PayPal"
                    class="h-6 opacity-70">
            </div>
        </div>
    </div>
