    ...
    <div class="max-w-6xl w-full grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="relative">
                ...
                <div class="relative bg-white rounded-3xl p-8 shadow-2xl">
                    ...
                    <p class="text-gray-600 mb-6">
                        Sign in to continue ordering delicious food from your favorite restaurants.
                    </p>
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700">Fast delivery in 30 minutes</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700">Fresh & quality ingredients</span>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700">Best prices & deals</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full">
                ...
                @if ($errors->any())
                    <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-lg">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="font-semibold text-red-800">Oops! Something went wrong</span>
                        </div>
                ...
                <form wire:submit.prevent="login" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="block w-full pl-12 pr-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 @error('email') border-red-500 @enderror"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-orange-500 hover:text-orange-600 transition-colors">
                                Forgot password?
                            </a>
                        @endif
                    </div>
            ...
            <div class="lg:hidden mt-8 space-y-4">
                <div class="flex items-center gap-3 bg-white rounded-2xl p-4 shadow-lg">
                    <div class="bg-orange-100 p-3 rounded-full">
                        <svg class="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                        </svg>
